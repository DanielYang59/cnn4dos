...
def cnn_for_dos(input_shape, drop_out_rate):
    ...
    def branch(branch_input, drop_out_rate, branch_activation="relu"):
        ...
        # 1st Conv layer
        conv_1 = tf.keras.layers.Conv2D(16, (3, 1), activation=branch_activation, padding="same")(branch_input) 
        conv_1 = tf.keras.layers.Conv2D(16, (3, 1), activation=branch_activation, padding="same")(conv_1)
        conv_1 = tf.keras.layers.Conv2D(16, (8, 1), (2, 1), activation=branch_activation, padding="same")(conv_1)
        conv_1 = tf.keras.layers.Dropout(drop_out_rate)(conv_1)


        # 2nd Conv layer
        conv_2 = tf.keras.layers.Conv2D(16, (3, 1), activation=branch_activation, padding="same")(conv_1)
        conv_2 = tf.keras.layers.Conv2D(16, (3, 1), activation=branch_activation, padding="same")(conv_2)
        conv_2 = tf.keras.layers.Conv2D(16, (8, 1), (2, 1), activation=branch_activation, padding="same")(conv_2)
        conv_2 = tf.keras.layers.Dropout(drop_out_rate)(conv_2)


        # 3rd Conv layer
        conv_3 = tf.keras.layers.Conv2D(16, (3, 1), activation=branch_activation, padding="same")(conv_2)
        conv_3 = tf.keras.layers.Conv2D(16, (3, 1), activation=branch_activation, padding="same")(conv_3)
        conv_3 = tf.keras.layers.Conv2D(16, (8, 1), (2, 1), activation=branch_activation, padding="same")(conv_3)
        ...
        # Branch output
        branch_output = tf.keras.layers.Dense(64, activation=branch_activation)(conv_flat)
        branch_output = tf.keras.layers.Dense(64, activation=branch_activation)(branch_output)
    ...
    master_output = tf.keras.layers.Dense(32, activation="relu")(master_flat)
    master_output = tf.keras.layers.Dense(16, activation="relu")(master_output) 
