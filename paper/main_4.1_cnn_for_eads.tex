...
\begin{figure}
    \centering
    \includegraphics[width=0.95\linewidth]{main_fig2_cnn.JPG}
    \caption{\textbf{CNN for Electronic Density of States.}
    a. Kendall rank correlation map illustrating the correlation between adsorption energy and some electronic and elementary descriptors. Definitions of the notations are provided in Supplementary \cref{si_table15:descriptor_notations}.
...
Originating from the pioneering work of Hammer and Nørskov \cite{hammer2000theoretical}, the d-band center model has emerged as a successful paradigm for employing descriptor to understand and predict the adsorption behavior on transition metal surfaces.
