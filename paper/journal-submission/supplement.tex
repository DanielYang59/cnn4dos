...
\subsection{Catalyst models and their thermodynamical stability}
\label{supp_sec2.1_catalysts}

Representative structures and thermodynamical stability for each substrate are
depicted in \cref{supp_fig2:Ge_g-C3N4} through \cref{supp_fig13:stability-C2N}.
For the adsorption process, the initial state is defined by positioning the
optimized adsorbates at a distance of 6.5 \text{\AA} from the single-metal
atoms supported on the substrate, oriented along the z-axis.
The thermodynamical stability is analyzed by calculate the energy change of the
single metal atom deposition process, where a more negative energy change
indicates more stable catalyst.

% SI Figure 1: Periodic table of investigated metals
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{supp_fig1_ptable.pdf}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{supp_fig2_Ge_g-C3N4.pdf}
...
% SI Figure 3: Stability of single metal atoms supported on g-C3N4
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{supp_fig3_stability_g-C3N4.pdf}
  \caption{\textbf{Stability of single metal atoms supported on graphitic nitride.}
  }
  \label{supp_fig3:stability_g-C3N4}
\end{figure}

% SI Figure 4: Structure of Cr atom supported on nitrogen-doped graphene
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{supp_fig4_Cr-n-gra.pdf}
  ...
  \label{supp_fig4:Cr-n-gra}
\end{figure}

% SI Figure 5: Stability of single metal atoms supported on nitrogen-doped graphene
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{supp_fig5_stability_N-graphene.pdf}
  \caption{\textbf{Stability of single metal atoms supported on graphitic nitride.}
  }
  \label{supp_fig5:stability-n-gra}
\end{figure}

% SI Figure 6: Structure of Os atom supported on graphene with dual-vacancy
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{supp_fig6_Os-gra-vac.pdf}
  ...
  indicates Os atom.}
  \label{supp_fig6:Os-gra-vac}
\end{figure}

% SI Figure 7: Stability of single metal atoms supported on graphene with dual-vacancy
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{supp_fig7_stability_V-graphene.pdf}
  \caption{\textbf{Stability of single metal atoms supported on graphitic nitride.}
  }
  \label{supp_fig7:stability-gra-vac}
\end{figure}

% SI Figure 8: Structure of Cr atom supported on black phosphorous
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{supp_fig8_Cr-BP.pdf}
  ...
  indicates Cr atom.}
  \label{supp_fig8:Cr-BP}
\end{figure}

% SI Figure 9: Stability of single metal atoms supported on black phosphorous
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{supp_fig9_stability_black-P.pdf}
  \caption{\textbf{Stability of single metal atoms supported on graphitic nitride.}
  }
  \label{supp_fig9:stability-BP}
\end{figure}

% SI Figure 10: Structure of Y atom supported on boron nitride
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{supp_fig10_Y-BN.pdf}
  ...
  \label{supp_fig10:Y-BN}
\end{figure}

% SI Figure 11: Stability of single metal atoms supported on boron nitride
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{supp_fig11_stability_BN.pdf}
  \caption{\textbf{Stability of single metal atoms supported on graphitic nitride.}
  }
  \label{supp_fig11:stability-BN}
\end{figure}

% SI Figure 12: Structure of Al atom supported on C2N
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{supp_fig12_Al-C2N.pdf}
  ...
  \label{supp_fig12:Al-C2N}
\end{figure}

% SI Figure 13: Stability of single metal atoms supported on C2N
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{supp_fig13_stability_C2N.pdf}
  \caption{\textbf{Stability of single metal atoms supported on graphitic nitride.}
  }
  \label{supp_fig13:stability-C2N}
\end{figure}

\subsection[CO2RR pathways]{CO\textsubscript{2}RR pathways}
\label{supp_sec2.2_co2rr_paths}

In this study, we explored three reaction pathways that have been previously documented in the literature \cite{durand2011structure, nie2014reaction, peterson2010copper}, as depicted in \cref{supp_fig14:co2rr_paths}.
...
% SI Figure 14: Three investigated CO2RR pathways
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.8\textwidth]{supp_fig14_co2rr_paths.pdf}
...
% SI Figure 16: Improvement in R2 from hybrid-descriptor method
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{supp_fig16_r2_hyb_des.pdf}
...
In addition to the selectivity volcano plot featured in the main text,
we provide a comprehensive plot capturing all rate-determining steps for
CO\textsubscript{2}RR in \cref{supp_fig17:rds_volcano}. A separate plot
focusing on selectivity over HER is also presented in \cref{supp_fig18:sel_volc}.

% SI Figure 17: CO2RR rate determining step volcano plot
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{supp_fig17_rds_volcano.pdf}
  \caption{\textbf{CO\textsubscript{2}RR rate determining step volcano plot.}
  This graph illustrates the rate-determining step associated with each region within
  the CO\textsubscript{2}RR process. Roman numerals denoting the respective RDS for each region.}
  \label{supp_fig17:rds_volcano}
\end{figure}

% SI Figure 18: CO2RR selectivity volcano plot
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{supp_fig18_sel_volc.pdf}
  ...
  \label{supp_fig18:sel_volc}
\end{figure}

\subsection{Activity periodic tables}
\label{supp_sec2.7_ptable}

% SI Figure 19: Limiting potential periodic table for nitrogen-doped graphene
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{supp_fig19_n-gra_ptable.pdf}
  \caption{\textbf{Limiting potential periodic table for nitrogen-doped graphene.}}
  \label{supp_fig19:n-gra_ptable}
\end{figure}

% SI Figure 20: Limiting potential periodic table for graphene with dual-vacancy
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{supp_fig20_gra-vac_ptable.pdf}
  \caption{\textbf{Limiting potential periodic table for graphene with dual-vacancy.}}
  \label{supp_fig20:gra-vac_ptable}
\end{figure}

% SI Figure 21: Limiting potential periodic table for black phosphorus
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{supp_fig21_BP_ptable.pdf}
  \caption{\textbf{Limiting potential periodic table for black phosphorus.}}
  \label{supp_fig21:BP_ptable}
\end{figure}

% SI Figure 22: Limiting potential periodic table for boron nitride
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{supp_fig22_BN_ptable.pdf}
  \caption{\textbf{Limiting potential periodic table for boron nitride.}}
  \label{supp_fig22:BN_ptable}
\end{figure}

% SI Figure 23: Limiting potential periodic table for monolayer C2N
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{supp_fig23_C2N_ptable.pdf}
  \caption{\textbf{Limiting potential periodic table for monolayer C\textsubscript{2}N.}}
  \label{supp_fig23:C2N_ptable}
\end{figure}
...
% SI Figure 24: d-band venter vs adsorption energy scatter plot
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{supp_fig24_d-band_eads.pdf}
  ...
  \label{supp_fig24:dband_vs_eads}
\end{figure}

\subsection{Feature correlation analysis}
\label{supp_sec3.2_feature_corr}

\cref{supp_fig25:pairwise_eads_des} displays the pairwise relationships between CO adsorption energy
...
% SI Figure 25: Pairwise plot of adsorption energy vs key descriptors
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{supp_fig25_pairwise_eads_des.pdf}
  ...
  on the Allen scale $\chi_\text{Allen}$, identified by Kendall rank correlation analysis.
  Data from all six substrates investigated in this study are included.}
  \label{supp_fig25:pairwise_eads_des}
\end{figure}
...
In this study, the array adopts a shape of [numSamplings, numOrbitals, numChannels], as illustrated in \cref{supp_fig26:input_dos}.
...
% SI Figure 26: Representation of the input eDOS data structure
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.3\textwidth]{supp_fig26_input_dos.pdf}
  \caption{\textbf{Schematic representation of the input eDOS data structure.}}
  \label{supp_fig26:input_dos}
\end{figure}
...
% SI Figure 27: Illustration of the eDOS occlusion experiment
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{supp_fig27_occlusion.pdf}
  ...
  \label{supp_fig27:occlusion}
\end{figure}

% SI Figure 28: Occlusion experiment with a masker width of 1
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.6\textwidth]{supp_fig28_occl_wid1.pdf}
  ...
  \label{supp_fig28:occl_wid1}
\end{figure}

% SI Figure 29: Occlusion experiment with a masker width of 3
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.6\textwidth]{supp_fig29_occl_wid3.pdf}
  \caption{\textbf{Occlusion Experiment with a masker width of ``3''.}
  This figure shows an occlusion experiment on the Ge atom in
  the initial state of CO adsorption on Ge@g-C\textsubscript{3}N\textsubscript{4}.}
  \label{supp_fig29:occl_wid3}
\end{figure}

% SI Figure 30: Occlusion experiment with a masker width of 5
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.6\textwidth]{supp_fig30_occl_wid5.pdf}
  \caption{\textbf{Occlusion Experiment with a masker width of ``5''.}
  This figure shows an occlusion experiment on the Ge atom in
  the initial state of CO adsorption on Ge@g-C\textsubscript{3}N\textsubscript{4}.}
  \label{supp_fig30:occl_wid5}
\end{figure}

% SI Figure 31: Occlusion experiment with a masker width of 11
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.6\textwidth]{supp_fig31_occl_wid11.pdf}
  \caption{\textbf{Occlusion Experiment with a masker width of ``11''.}
  This figure shows an occlusion experiment on the Ge atom in
  the initial state of CO adsorption on Ge@g-C\textsubscript{3}N\textsubscript{4}.}
  \label{supp_fig31:occl_wid11}
\end{figure}

% SI Figure 32: Occlusion experiment with a masker width of 21
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.6\textwidth]{supp_fig32_occl_wid21.pdf}
  \caption{\textbf{Occlusion Experiment with a masker width of ``21''.}
  This figure shows an occlusion experiment on the Ge atom in
  the initial state of CO adsorption on Ge@g-C\textsubscript{3}N\textsubscript{4}.}
  \label{supp_fig32:occl_wid21}
\end{figure}

% SI Figure 33: Occlusion experiment with a masker width of 31
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.6\textwidth]{supp_fig33_occl_wid31.pdf}
  \caption{\textbf{Occlusion Experiment with a masker width of ``31''.}
  This figure shows an occlusion experiment on the Ge atom in
  the initial state of CO adsorption on Ge@g-C\textsubscript{3}N\textsubscript{4}.}
  \label{supp_fig33:occl_wid31}
\end{figure}

% SI Figure 34: Occlusion experiment with a masker width of 41
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.6\textwidth]{supp_fig34_occl_wid41.pdf}
  \caption{\textbf{Occlusion Experiment with a masker width of ``41''.}
  This figure shows an occlusion experiment on the Ge atom in
  the initial state of CO adsorption on Ge@g-C\textsubscript{3}N\textsubscript{4}.}
  \label{supp_fig34:occl_wid41}
\end{figure}

% SI Figure 35: Occlusion experiment with a masker width of 51
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.6\textwidth]{supp_fig35_occl_wid51.pdf}
  \caption{\textbf{Occlusion Experiment with a masker width of ``51''.}
  This figure shows an occlusion experiment on the Ge atom in
  the initial state of CO adsorption on Ge@g-C\textsubscript{3}N\textsubscript{4}.}
  \label{supp_fig35:occl_wid51}
\end{figure}

\subsection{Shifting experiment}
\label{supp_sec3.6_shifting}

% SI Figure 36: Illustration of the eDOS shifting experiment
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{supp_fig36_shifting.pdf}
  ...
  \label{supp_fig36:shifting}
\end{figure}

% SI Figure 37: Shifting experiment on p orbital
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.75\textwidth]{supp_fig37_p_shifting.pdf}
...
as well as \cref{supp_fig27:occlusion} and \cref{supp_fig36:shifting},
