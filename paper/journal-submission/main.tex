...
\subsection{Validation of CNN predictions}
    ...
    Additionally, occlusion experiments were performed on the Co $d_{xy}$ orbital of Co@g-C\textsubscript{3}N\textsubscript{4} (\cref{main_fig4:validation}b) and the Cu $d_{xy}$ orbital of Cu@g-C\textsubscript{3}N\textsubscript{4} (\cref{main_fig4:validation}c).
    In both cases, the $d_{xy}$ orbital was identified as the dominant contributor.
