...
\section{Introduction}
    ...
    Building on this, we introduced an orbital-wise eDOS occlusion experiment,
    inspired by the occlusion technique commonly used in computer vision and pattern recognition.
...
\subsection{eDOS shifting experiments for prediction of better catalysts}
    ...
    as shown in Supplementary \cref{supp_fig37:p_shifting} and found no significant response.
...
\section{Methods}
    ...
    as demonstrated in Supplementary \cref{supp_fig16:r2_hyb_des} and Supplementary \cref{supp_table13:scaling_params}.
    ...
    Supplementary \cref{supp_fig27:occlusion} visually illustrates the eDOS occlusion
...
\newpage
    ...
    (FT160100281, FT180100387, DP200103568, DP230101625).
