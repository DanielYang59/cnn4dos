...
\subsection{Hybrid descriptors enabled volcano plot for catalyst analysis}
    ...
    Given that HER is a key competing reaction with CO\textsubscript{2}RR \cite{goyal2020competition}, we also incorporated a selectivity volcano plot, calculated as the difference between the limiting potentials of CO\textsubscript{2}RR and HER reactions, presented in Supplementary \cref{supp_fig18:sel_volc}, to offer a comprehensive analysis of catalyst candidates.
