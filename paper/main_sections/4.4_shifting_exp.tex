% Results and Discussion Part Four: Shifting experiments for prediction of better catalysts
...
\begin{figure}
    \centering
    \includegraphics[width=0.95\linewidth]{main_sections/figures/main_fig5_shifting.JPG}
