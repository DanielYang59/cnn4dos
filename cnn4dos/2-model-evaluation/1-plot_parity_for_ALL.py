"""Create parity plot for all adsorbates in a single plot."""
...
if __name__ == "__main__":
    ...
    # Create color filling
    right_img = g.ax_marg_y.imshow(
        right_x.reshape(-1, 1)[::-1, :],
    ...
    right_poly = g.ax_marg_y.fill_betweenx(
    ...
    plt.tight_layout()
    plt.savefig(os.path.join("figures", "parity_plot_ALL.png"), dpi=300)
    # plt.show()
