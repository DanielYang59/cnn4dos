...
def heatmap(x, y, **kwargs):
    ...
    if "palette" in kwargs:
        ...
        n_colors = 128  # Use 128 colors for the diverging color palette
    ...
    # Change marker color in the diagonal to grey
    marker_color = []
    for v in color:
    ...
    plt.xticks(fontsize=12, rotation=70)  # rotate to avoid overlap
    ...
    if color_min < color_max:
        ...
        ax.set_xlim(
            1, 2
        )  # Bar going from 0 to 5, so crop the plot somewhere in the middle
