...
def load_limiting_potential(path, substrate, name_col=0, potential_col=1):
    ...
    Args:
        ...
        potential_col (int, optional): limiting potential column index.
            Defaults to 1.
    ...
    for _, row in df.iterrows():
        ...
        # name comes in "g-C3N4_is_4-Co" format
        if name.split("_")[0] == substrate:
...
if __name__ == "__main__":
    load_limiting_potential(
        path="../../../5-volcano-plot/src/test/debug_results/diff_limiting_potential.csv",  # noqa: E501
        substrate="g-C3N4",
    )
